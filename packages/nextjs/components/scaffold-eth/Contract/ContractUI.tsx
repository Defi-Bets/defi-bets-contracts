    ...
    <div className={`grid grid-cols-1 lg:grid-cols-6 px-6 lg:px-10 lg:gap-12 w-full max-w-7xl my-0 ${className}`}>
      <div className="col-span-5 grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-10">
        <div className="col-span-1 flex flex-col">
          <div className="bg-base-200 border-base-200 border shadow-md shadow-primary rounded-3xl px-6 lg:px-8 mb-6 space-y-1 py-4">
            <div className="flex">
        ...
        <div className="col-span-1 lg:col-span-2 flex flex-col gap-6">
          <div className="z-10">
            <div className="bg-base-100 rounded-3xl shadow-md shadow-primary border border-base-300 flex flex-col mt-10 relative">
